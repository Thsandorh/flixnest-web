    ...
    <main className="min-h-screen bg-zinc-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-zinc-400 mt-2">Join Flixnest today</p>
        </div>
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-red-600 hover:bg-red-700 disabled:bg-zinc-800 disabled:text-zinc-500 py-3 rounded-xl font-bold text-white transition-all flex items-center justify-center gap-2 mt-4"
            >
              {isLoading ? (
          ...
          <div className="mt-8 text-center">
            <p className="text-zinc-400">
              ...
              <Link href="/login" className="text-white font-semibold hover:text-red-500 transition-colors">
                Sign in
              </Link>
            </p>
          </div>

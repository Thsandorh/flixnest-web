...
export function VideoPlayer({
    ...
    const setupPlayback = () => {
      ...
      if (!playerRef.current) {
        const player = videojs(v, {
          ...
          fluid: true,
          poster,
          sources: [{ src: finalUrl, type: sourceType }],
        });
      ...
      playerRef.current.src({ src: finalUrl, type: sourceType });
  ...
  }, [src, headers, startTime, poster, onPlay, onPause, onEnded, destroyPlayer]);

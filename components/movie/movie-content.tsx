    ...
    <div className="container-wrapper-movie">
      ...
      <div className="hidden lg:flex justify-end">
        <div className="w-3/4 pl-14 pt-6 space-y-8">
          <table className="w-full">
            <tbody>
              <tr>
                <td className="pb-3 w-1/5 align-top uppercase text-base">Director</td>
                <td className="pb-3 font-bold">{directors}</td>
              </tr>
              <tr>
                <td className="pb-3 align-top uppercase text-base">Country</td>
                <td className="pb-3 font-bold">{countries}</td>
              </tr>
              <tr>
                <td className="pb-3 align-top uppercase text-base">Release year</td>
      ...
      <div className="lg:hidden px-4 py-6 space-y-6">
        ...
        <div className="bg-gray-900/50 rounded-lg p-4 space-y-4">
          <h3 className="text-lg font-bold text-white mb-4">Movie information</h3>

          {/* Director */}
          <div className="flex flex-col space-y-1">
            <span className="text-sm text-gray-400 uppercase tracking-wide">Director</span>
            <span className="text-white font-medium">{directors}</span>
          </div>

          {/* Country */}
          <div className="flex flex-col space-y-1">
            <span className="text-sm text-gray-400 uppercase tracking-wide">Country</span>
            <span className="text-white font-medium">{countries}</span>
          </div>

          {/* Release Year */}
          <div className="flex flex-col space-y-1">
            <span className="text-sm text-gray-400 uppercase tracking-wide">Release year</span>
        ...
        <div className="bg-gray-900/50 rounded-lg p-4">
          <h3 className="text-lg font-bold text-white mb-4">Movie content</h3>
          <MovieSummary summary={movie.movie.content} />
        </div>

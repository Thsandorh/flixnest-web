      ...
      <div className="pt-20 lg:pt-32 container-wrapper-movie h-full px-4 lg:px-0">
        <div className="flex justify-center items-center py-20">
          <div className="text-center">
            <h2 className="text-white text-xl font-semibold mb-4">Please sign in</h2>
            <p className="text-gray-400">You need to sign in to view personal information</p>
          </div>
        </div>
      </div>
    );
  ...
  return (
    <div className="pt-20 lg:pt-32 container-wrapper-movie h-full px-4 lg:px-0">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-2xl lg:text-3xl font-bold text-white mb-2">Personal information</h1>
